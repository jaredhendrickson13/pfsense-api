...
The REST API contains magic parameters to control the behavior of the API call. These parameters are available to
...
- Type: Boolean
- Default: `true`
- Description: This parameter allows you to control the default API behavior of applying changes synchronously. Setting
...
- Description: This parameter allows you to control the default API behavior of _not_ applying changes to the pfSense
  ...
  is useful when you are making a small change and want to apply it immediately without making a separate API call to the
  applicable apply endpoint. This may not be applicable to all endpoints as some always apply changes immediately.
