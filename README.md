...
* [USER/AUTH_SERVER](#userauth_server)
    1. [Read Auth Servers](#1-read-auth-servers)
    1. [Read LDAP Auth Servers](#2-read-ldap-auth-servers)
    1. [Create LDAP Auth Servers](#3-create-ldap-auth-servers)
    1. [Delete LDAP Auth Servers](#4-delete-ldap-auth-servers)
    1. [Delete RADIUS Auth Servers](#5-delete-radius-auth-servers)
    1. [Create RADIUS Auth Servers](#6-create-radius-auth-servers)
    1. [Delete Auth Servers](#7-delete-auth-servers)
    1. [Read RADIUS Auth Servers](#8-read-radius-auth-servers)
...
### 2. Create DHCPd Static Mappings
...
### 3. Update DHCPd Static Mappings
...
### 4. Delete DHCPd Static Mappings
...
### 2. Read DHCPd Service Configuration
...
### 3. Update DHCPd Service Configuration
...
### 2. Update dnsmasq Host Override
...
### 3. Delete dnsmasq Host Override
...
### 5. Apply Pending dnsmasq Changes
...
### 2. Update Unbound Host Override
...
### 3. Delete Unbound Host Override
...
### 5. Apply Pending Unbound Changes
...
### 1. Read OpenVPN Client Specific Overrides
...
### 2. Create OpenVPN Client Specific Overrides
...
### 3. Update OpenVPN Client Specific Overrides
...
### 2. Create Outbound NAT Mappings
...
### 3. Update Outbound NAT Mappings
...
### 4. Delete Outbound NAT Mappings
...
| gateway | string | Update the routing gateway traffic will take upon match. Specify `default` or an empty string to revert this field to the default gateway. (optional) |
